...
modelToLoad = "/home/hemanth/Downloads/lode_runner/GAN_pytorch/model_epoch_1000_0_32.pth"
...
print(im)
im = im[:, :, :16, :28]  # Cut of rest to fit the 16x28 tile dimensions
im = numpy.argmax(im, axis  =1)
print(im)

import json
with open('/home/hemanth/Downloads/lode_runner/decode_levels/latent_levels.json', 'w') as outfile:
